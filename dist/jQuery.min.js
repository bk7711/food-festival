!(function (e, t) {
  ...
  (b.filter = function (e, t, n) {
    ...
    b.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && S.test(e) ? b(e) : e || [], !1)
          .length;
      },
    });
  var j,
    ...
    return (
      (n =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && N(e, t)) ? b.merge([e], n) : n
    );
  }
  function ye(e, t) {
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && N(t, "input") && De(t, "click", ke),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && N(t, "input") && De(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  b.ajaxSetup({
    ...
    b.each(["top", "left"], function (e, t) {
      b.cssHooks[t] = ze(h.pixelPosition, function (e, n) {
        if (n)
          return (n = _e(e, t)), $e.test(n) ? b(e).position()[t] + "px" : n;
      });
    }),
